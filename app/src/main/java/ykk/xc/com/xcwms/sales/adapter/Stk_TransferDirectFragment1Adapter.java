...
public class Stk_TransferDirectFragment1Adapter extends BaseArrayRecyclerAdapter<ScanningRecord2> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Stk_TransferDirectFragment1Adapter(Activity context, List<ScanningRecord2> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.stk_transferdirect_fragment1_item;
    }
