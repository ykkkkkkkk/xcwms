...
public class Supplier_DialogAdapter extends RecyclerView.Adapter<Supplier_DialogAdapter.MyViewHolder> {

    private List<Supplier> datas;//存放数据
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.ab_supplier_dialog_item, parent, false);
