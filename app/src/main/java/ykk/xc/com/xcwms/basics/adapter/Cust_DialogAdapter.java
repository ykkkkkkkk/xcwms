...
public class Cust_DialogAdapter extends RecyclerView.Adapter<Cust_DialogAdapter.MyViewHolder> {

    private List<Customer> datas;//存放数据
    ...
    public void onBindViewHolder(MyViewHolder holder, final int pos) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            mholder.tv_fnumber.setText(datas.get(pos).getCustomerCode());
            mholder.tv_fname.setText(datas.get(pos).getCustomerName());
        }
    }
