 ...
 * 库位列表适配器
 */
public class ProductBarcode4Adapter extends BaseArrayRecyclerAdapter<StockPosition> {

    private Activity context;
    private MyCallBack callBack;

    public ProductBarcode4Adapter(Activity context, List<StockPosition> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.ab_print_code_item4;
    }

    @Override
    public void onBindHoder(RecyclerHolder holder, final StockPosition entity, final int pos) {
            // 初始化id
    ...
    public interface MyCallBack {
        void onPrint(StockPosition entity, int position);
    }
