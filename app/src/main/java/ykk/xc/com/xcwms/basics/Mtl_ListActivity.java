...
import ykk.xc.com.xcwms.basics.adapter.Mtl_ListAdapter;
...
public class Mtl_ListActivity extends BaseDialogActivity implements XRecyclerView.LoadingListener {
    ...
    private List<Mtl> listDatas = new ArrayList<>();
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (m != null) {
                ...
                switch (msg.what) {
                    case SUCC1: // 成功
                        List<Mtl> list = JsonUtil.strToList2((String) msg.obj, Mtl.class);
...
//                        m.listDatas = m.gGson().fromJson((String) msg.obj, new TypeToken<List<mtl>>(){}.getType());
    ...
    private void run_okhttpDatas() {
        showLoadDialog("加载中...");
        String mUrl = Consts.getURL("findMtlListByParam");
...
//                .add("pageSize", "100")
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.e("Mtl_ListActivity --> onResponse", result);
