...
public class StockPos_DialogAdapter extends RecyclerView.Adapter<StockPos_DialogAdapter.MyViewHolder> {

    private List<StockPosition> datas;//存放数据
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.ab_stock_pos_dialog_item, parent, false);
