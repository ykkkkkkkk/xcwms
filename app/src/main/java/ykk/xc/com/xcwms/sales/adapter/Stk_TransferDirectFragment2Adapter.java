...
public class Stk_TransferDirectFragment2Adapter extends BaseArrayRecyclerAdapter<ScanningRecord2> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Stk_TransferDirectFragment2Adapter(Activity context, List<ScanningRecord2> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.stk_transferdirect_fragment2_item;
    }
