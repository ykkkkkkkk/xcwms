...
public class Pur_InActivityTemp extends BaseActivity {
    ...
    private Pur_InActivityTemp context = this;
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<Pur_InActivityTemp> mActivity;

        public MyHandler(Pur_InActivityTemp activity) {
            mActivity = new WeakReference<Pur_InActivityTemp>(activity);
        }

        public void handleMessage(Message msg) {
            Pur_InActivityTemp m = mActivity.get();
            if (m != null) {
                m.hideLoadDialog();
