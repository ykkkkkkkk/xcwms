...
public class Stock_DialogAdapter extends RecyclerView.Adapter<Stock_DialogAdapter.MyViewHolder> {

    private List<Stock> datas;//存放数据
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.ab_stock_dialog_item, parent, false);
