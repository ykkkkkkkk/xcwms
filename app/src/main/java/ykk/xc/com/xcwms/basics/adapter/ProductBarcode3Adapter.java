 ...
 * 库区列表适配器
 */
public class ProductBarcode3Adapter extends BaseArrayRecyclerAdapter<StockArea> {

    private Activity context;
    private MyCallBack callBack;

    public ProductBarcode3Adapter(Activity context, List<StockArea> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.ab_print_code_item3;
    }

    @Override
    public void onBindHoder(RecyclerHolder holder, final StockArea entity, final int pos) {
            // 初始化id
    ...
    public interface MyCallBack {
        void onPrint(StockArea entity, int position);
    }
