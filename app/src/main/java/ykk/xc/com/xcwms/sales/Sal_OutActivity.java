...
public class Sal_OutActivity extends BaseActivity {
    ...
    private static final int SEL_ORDER = 10, SEL_CUST = 11, SEL_STOCK = 12, SEL_STOCKA = 13, SEL_STOCKP = 14, SEL_DEPT = 15, SEL_MAT = 16, SEL_BATCH = 17, SEL_SEQUENCE = 18;
    ...
    @OnClick({R.id.btn_close, R.id.btn_sourceNo, R.id.btn_maker_code, R.id.tv_custSel, R.id.btn_whName, R.id.tv_batchNo, R.id.tv_sequenceNo,
            R.id.btn_whArea, R.id.btn_whPos, R.id.btn_selMat, R.id.btn_add, R.id.btn_save, R.id.btn_clone})
