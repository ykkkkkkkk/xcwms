...
public class Sal_OutActivity extends BaseActivity {
    ...
    private static final int SEL_ORDER = 10, SEL_CUST = 11, SEL_STOCK = 12, SEL_STOCKA = 13, SEL_STOCKP = 14, SEL_DEPT = 15, SEL_MAT = 16, SEL_BATCH = 17, SEL_SEQUENCE = 18, SEL_ORGANIZATION = 19, SEL_ORGANIZATION2 = 20;
...
//                                break;
//                            case '4':
//                                m.mat = JsonUtil.strToObject((String) msg.obj, Mtl.class);
//                                m.setTexts(m.etMatNo, m.mat.getFnumber());
//                                m.matBarcode = m.mat.getFnumber();
//                                if (m.dataType == '1') { // 来源单
//                                    if (m.mat.getIs_sn()) {
...
//                                        if (m.mat.getK3FitemId() == sr2.getMtl().getK3FitemId() && !sr2.getMtl().getIs_sn() && sr2.getFqty() > sr2.getStockqty()) {
...
//                                break;
//                            case '5':
//                                List<SeOrder> list = JsonUtil.strToList2((String) msg.obj, SeOrder.class);
...
//                showForResult(Sal_OrderActivity.class, SEL_ORDER, bundle);
//
//                break;
//            case R.id.tv_custSel: // 选择客户
//                showForResult(Organization_DialogActivity.class, SEL_CUST, null);
//
//                break;
...
//                    return;
//                }
//                showForResult(Mtl_ListActivity.class, SEL_MAT, null);
//
//                break;
...
//
//                break;
//            case R.id.tv_salOrganization: // 销售组织
...
//        if (mat.getIs_sn() && seqNo.length() == 0) {
...
//        sr2.setFitemId(mat.getK3FitemId());
//        sr2.setMtl(mat);
...
//        for (int j = 0, sizej = checkDatas.size(); j < sizej; j++) {
//            ScanningRecord2 sr2a = checkDatas.get(j);
//            if (mat.getK3FitemId() == sr2a.getFitemId()) {
//                if (!mat.getIs_sn()) { // 没有启用序列化
//                    sr2a.setFqty(sr2a.getFqty() + num);
//                    sr2a.setStockqty(sr2a.getStockqty() + num);
//                    isAlike = true;
//                }
...
//                    if (bundle != null) {
//                        List<SeOrder> list = (List<SeOrder>) bundle.getSerializable("checkDatas");
...
//                if (resultCode == RESULT_OK) {
//                    salOrganization = (Organization) data.getSerializableExtra("obj");
//                    Log.e("onActivityResult --> SEL_DEPT", salOrganization.getName());
...
//     * 选择来源单返回
//     */
//    private void getSourceAfter(List<SeOrder> list, boolean isSaoma) {
//        for (int i = 0, size = list.size(); i < size; i++) {
//            SeOrder s = list.get(i);
//            ScanningRecord2 sr2 = new ScanningRecord2();
//            sr2.setTmpSourceId(s.getId());
//            sr2.setType(2);
//            sr2.setSourceFinterId(s.getId());
//            sr2.setFitemId(s.getMtl().getK3FitemId());
//            sr2.setMtl(s.getMtl());
//            sr2.setBatchno(""); // 批号默认为空
//            sr2.setSequenceNo(""); // 批号默认为空
//            sr2.setFqty(s.getSeorderFqty());
...
//        if (salOrganization != null) {
//            tvSalOrganization.setText(salOrganization.getName());
//        }
//    }
//
//    /**
